...
DATABASES = {
    'default': {
        ...
        # -------------------------------------------------------------------------------------------
        # 'NAME': '/home/mario555/recetario_mario/recetario_mario.db',  # Puesta en Producción        
        'NAME': 'recetario_mario.db', # Proyecto de manera Local 
        # -------------------------------------------------------------------------------------------           
...
# MEDIA_ROOT = '/home/mario555/recetario_mario/recetario_mario/carga' # Proyecto en Producción
...
# STATICFILES_DIRS = '/home/mario555/recetario_mario/recetario_mario/static' # Proyecto en Producción
...
# TEMPLATE_DIRS = ('/home/mario555/recetario_mario/recetario_mario/plantillas'), # Proyecto en Produccion
